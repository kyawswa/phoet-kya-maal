...
import 'package:flutter_app_bloc/bloc/bloc_delegates.dart';
import 'package:flutter_app_bloc/bloc/order/order.dart';
import 'package:flutter_app_bloc/order_details_screen.dart';
...
void main() {
  ...
  runApp(BlocProvider(create: (context){
    return OrderBloc(OrderService())..add(OrderAdded(order));
  },
    child: MyApp(order: order,),
  ));
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: OrderDetailsScreen(order: order,)//MyHomePage(title: 'Flutter Demo Home Page'),
    );
  }
}
